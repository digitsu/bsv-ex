defmodule BSV.ExtKeyTest do
  ...
  @extkey %BSV.ExtKey{
    chain_code:
      <<178, 208, 232, 46, 183, 65, 27, 66, 14, 172, 46, 66, 222, 84, 220, 98, 70, 249, 25, 3, 50,
        209, 218, 236, 96, 142, 211, 79, 59, 166, 41, 106>>,
    child_index: 0,
    depth: 0,
    fingerprint: <<0, 0, 0, 0>>,
    privkey: %BSV.PrivKey{
      compressed: true,
      d:
        <<219, 231, 28, 56, 5, 76, 224, 63, 77, 224, 151, 38, 251, 136, 26, 87, 11, 186, 248, 245,
          84, 56, 152, 11, 115, 35, 148, 32, 239, 241, 174, 90>>
    },
    pubkey: %BSV.PubKey{
      compressed: true,
      point: %Curvy.Point{
        x:
          81_914_731_537_127_506_607_736_443_451_065_612_706_836_400_740_211_682_375_254_444_777_841_949_022_440,
        y:
          84_194_918_502_426_421_393_864_928_067_925_727_177_552_578_328_971_362_502_574_621_746_528_696_729_690
      }
    },
  ...
  describe "ExtKey.derive/2" do
    ...
    test "derives correct bip44 nodes from master priv key", %{priv: master} do
      ...
      assert ExtKey.to_string(account) ==
               "xprvA1RdrGBCqcpUbBgZ2morRPu4SwindxTuSi7GLun1WZddUQq3c8bnUmzTLuNHoYDD8FkytWaJsXawSFBz7t9jY5gYYVG4hcs9k7s9bV4WzFn"

      assert ExtKey.to_public(account) |> ExtKey.to_string() ==
               "xpub6EQzFmi6fzNmofm28oLrnXqnzyZH3RBkow2s9JBd4uAcMDAC9fv32aJwCBPn9ovGi1xbjQhBP6XMkbYCQ4py7QHjyxepAcK3Qo3V6moAwAJ"

      [
        {"m/0", "039bb356dd5fe893296182da6af34deef37f435ebb4212f3c8073feed722b797e6",
         "KwMJSp6vrMhjHCy76Lgr8NyV6gMBZ69XpyZ6bksMX2cHaqU68m5L"},
        {"m/5", "02783246d5ffecea6cdc7b6c260824a0e7cfe478df2e30c9adf6527e1b9087c1a2",
         "KxkB8HJ2M6GvqeMkY1UEmFzFncACvkZg58gkRYD95NwYjxqJEAXH"},
        {"m/10", "039dc8d9c946c662d64bc265e67260b0ac0d447adaba3dedc646505aa5029944ad",
         "L4mAoyb9oN6SEa5wYrUp9zJDatDJHaRgmEhNcPGWHamjwQJAr5eE"},
        {"m/15", "0339db294ebb2df7bf99f3bd492141adef8acfe0d16fdc6825a84d9c0217f68aab",
         "L37A3mMWZjFcXGvWKR1nkcaYMPx657HBz8W6LPDCBGFzJRPhCpUN"}
      ]
      |> Enum.each(fn {path, pubkey, wif} ->
