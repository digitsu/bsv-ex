defmodule BSV.MessageTest do
  ...
  describe "Message.decrypt/3 external messages" do
    setup do
      privkey =
        <<189, 138, 106, 93, 22, 48, 176, 218, 61, 84, 36, 235, 171, 24, 246, 159, 24, 34, 109,
          50, 221, 28, 136, 78, 120, 184, 60, 221, 223, 131, 158, 44>>
    ...
    test "decrypt message from bsv.js", %{privkey: privkey} do
      data =
        "QklFMQMtEGxuc+iWInmjAwv6TXBZeH9qSGAygd86Cl3uM8xR7HDRahwebjAI05NEaSsXdGU7uwDZB01idKa9V1kaAkavijnrlUXIkaaIZ1jxn+LzUy0PxUCx7MlNO24XHlHUoRA="
    ...
    test "decrypt message from Electrum", %{privkey: privkey} do
      data =
        "QklFMQMtfEIACPib3IMLXziejcfFhP6ljTbudAzTs1fnsc8QDU2fIenGbSH0XXUBfERf4DgYnrh7gmH98GymM2oHUkXoaVXpOWnwd5h+VtydSUDM0r4HO5RwwfIOUmfsLmNQ+t0="
  ...
  describe "Message.verify/4 external messages" do
    test "verify signature from random bsv address 1" do
      ...
      sig =
        "IOKYfXRrvFGa43gxBiqsTVq8SYZGVbBo4IRD5Sw285weNwABWwCgHx/uxiIh1T7ucOunBXUPSanU61z7vkMFqi4="
    ...
    test "verify signature from random bsv address 2" do
      ...
      sig =
        "HwIB0nCuTgDHnKG0uoWVPWMTaO3XOa6MtvkuZYDr4hOqZ8T78qOIa3afqIVltZahsKTtpEErnflgvQVVPIk+YJQ="
    ...
    test "verify signature from random bsv address 3" do
      ...
      sig =
        "INX0XYbxs8ZW+mwTem198w0L/JvZkYUb/KikUt/fIf9+bSKaMijQD0nQso/RA5n6NrzZu5ok3lpgE3VzJPPS3Yk="
