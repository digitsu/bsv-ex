defmodule BSV.Contract.P2STAS do
  ...
  * `:keypair` - A `t:BSV.KeyPair.t/0` struct.
  ...
  def op_stas(ctx) do
    stas = BSV.Script.from_asm!(@op_stasnft)
    Enum.reduce(Map.get(stas, :chunks), ctx, &asm_push/2)
  end
